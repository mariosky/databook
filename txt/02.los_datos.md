...
Muchos que llevamos o impartimos cursos de *Bases de Datos* tenemos la idea equivocada de que la *Minería de Datos* consiste en algún tipo de extensión a los lenguajes de consulta relacionales como SQL. La verdad es que la gran mayoría de los algoritmos que utilizamos toman como entrada arreglos de vectores. Recordemos que las algoritmos han sido desarrollado por especialistas en áreas bien distintas como álgebra lineal, inferencia estadística, inteligencia artificial, reconocimiento de patrones, etc. Por un lado la lógica y el modelo relacional no son lenguajes comunes en estas áreas, y por otro lado las matrices nos permiten expresar operaciones de una manera muy eficiente. Es por esto que los primeros pasos del proceso de KDD están dedicados a pasar los datos a un formato vectorial. Podemos pensar que los algoritmos son cajas negras que toman a los datos en cierto formato y como resultado arrojan los patrones. Como ejemplo veamos los requerimientos de entrada de algunos algoritmos de aprendizaje automático en su versión básica:

Redes neuronales artificiales:

Inferencia de árboles de decisión:
