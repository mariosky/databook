...
La materia prima para que extraeremos en nuestra labor de mineros de
datos es inagotable. De hecho el reto es que se genera más minuto a
minuto. Hablamos de los datos, ese recurso en bruto que debemos
procesar para sacarle provecho. En esta sección discutiremos temas
relacionados con los datos y su procesamiento: 
* Vamos a definir los datos como objetos.
...
confundir a los que hablamos castellano. Como primer paso vamos a
definir los conceptos básicos utilizando de ser posible términos que
sean familiares a los profesionistas en informática. 
