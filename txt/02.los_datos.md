...
Cuando utilizamos la estructura de tabla, en algunas bibliotecas o software como Orange o Rapid Miner se pueden especificar metadatos por ejemplo:
...
Por ejemplo los metadatos para el conjunto de datos Iris que se muestra a continiación
...
La información que sabemos sobre cada atributo o mejor dicho sus metadatos son los siguientes:
...
| species      | nominal        | etiqueta       |       |

En otros casos se requieren dos arreglos, uno para las características:
``` python
[[5.1, 3.5, 1.4, 0.2], # setosa
 [4.9, 3.0, 1.4, 0.2], # setosa
 [7.0, 3.2, 4.7, 1.4], # versicolor
