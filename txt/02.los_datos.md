...
``` 
Es importante conocer los tipos de variables, por ejemplo en este caso vemos como todas las características son continuas y las etiquetas con categóricas. Entonces tenemos que utilizar algoritmos que puedan recibir este tipo de datos. Existen algoritmos por ejemplo, que no pueden trabajar  datos categóricos o aquellos en los que la etiqueta debe ser binaria. En la sección de preprocesamiento veremos varias técnicas que podremos utilizar para modificar los datos de tal manera que podamos emplear de mejor manera la mayor cantidad de algoritmos posible.   
