...
Si queremos especificar el indice lo podemos hacer pasando un diccionario por cada atributo:

``` python
>>>> datos = {'nombre':{'row1':'ana','row2':'tom','row3':'joe'}, 'email':{'row1': 'ann@example.com','row2':'tommy@example.com','row3':'jj@example.com'}}
