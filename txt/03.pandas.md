...
### index
Aqui se puede especificar el indice o nombre de cada renglón.
 
### columns
Aqui se puede especificar el nombre de cada atributo o columna.

Para el ejemplo anterior, vamos a pasar ciertos valore para *index* y *columns*:
