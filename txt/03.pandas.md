...
```
Un detalle de este ejemplo es que al utilizar el corte por etiqueta *loc* los valores que se ponen en la especificación del rango *19:55* corresponden a la etiqueta no a la posición.
