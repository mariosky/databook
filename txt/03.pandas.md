...
``` python
In [39]: datos = { 'Tijuana': {'Tijuana':0,'Ensenada':104.2,'Mexicali':185.5}, 
...
¿Y que tal una matriz para filtrado colaborativo?
...
También más adelante veremos como "girar" la matriz para tener en los renglones a las películas y en las columnas a los usuarios.  
