...
Vamos a ahora otro ejemplo de un discriminante lineal, en el cual se hace una transformación fija no-lineal del vector de entrada $\phi(\vec{w})$. En lugar de utilizar simplemente el signo del producto punto entre los vectores, ahora se introduce una función de activación. El modelo lineal genralizado tiene la forma
