...
Por ejemplo, los valores de peligrosidad: "Nada", "Regular", "Mucho", "¡Corre!" ; talla de la ropa , el nivel máximo de estudios.   
* Los operadores que podemos utilizar son: $=$, $\neq$, $>$, $<$.
