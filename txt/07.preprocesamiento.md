...
Por ejemplo, si solo consideramos los términos Jugador y Tiro, tendríamos los siguientes vectores:

![Vectores](../img/vectors-docs.png)

En estos casos, el escalado de las características se hace por cada documento.
Para esto se escalan los componentes del vector de tal manera que tenga una longitud de uno. Esto normalmente significa dividir cada componente entre la longitud euclidiana del vector, a esto se le llama norma L2:
