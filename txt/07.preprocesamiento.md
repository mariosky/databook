...
# Normalización
Algunos algoritmos de clasificación de textos utilizan un modelo de espacio vectorial. En este modelo cada documento es representado como un vector que representa la ponderación que tiene cada término del documento. Por ejemplo, tenemos estos documentos:

|             | Home Run | Gol  | Carrera | Penal |  Tiro | Doble Play |
|-------------|----------|------|---------|-------|-------|------------|
| Documento 1 |     3    |  0   |    3    |  0    | 3     |   2        |  
| Documento 2 |     0    |  5   |    1    |  3    | 0     |   0        |
| Documento 3 |     0    |  0   |    3    |  3    | 3     |   0        |
| Documento 4 |     5    |  0   |    4    |  0    | 3     |   3        |
...
En estos casos, el escalado de las características se hace por cada documento. Para esto se escalan los componentes del vector de tal manera que tenga una longitud de uno. Esto normalmente significa dividir cada componente entre la longitud euclidiana del vector, a esto se le llama norma L2:
...
>>> X_train = np.array([[ 3., 2.], [6., 4.]])
>>> X_normalized = preprocessing.normalize(X_train, norm='l2')

>>> X_normalized
array([[ 0.83205029,  0.5547002 ],
       [ 0.83205029,  0.5547002 ]])
>>> np.dot(X_normalized[0],X_normalized[1])
   1.0
```
En este ejemplo en 2D, los documentos tienen la misma dirección y se consideran documentos iguales, lo comprobamos con el producto punto nos da 1.
