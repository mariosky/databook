...
Los documentos menos similares son el d1 y d2, ya que el ángulo entre ellos es mayor. Los más similares son d3 y d4 ya que tienen el mismo ángulo.

El cálculo de estos ángulos se simplificaría si todos los vectores tuvieran una longitud unitaria. Esto normalmente significa dividir cada componente entre la longitud euclidiana del vector (a esto se le llama norma L2). A este escalado de las características de los documentos se le llama normalización. Como vemos en la siguiente figura los vectores anteriores se han escalado considerando una longitud o norma euclidiana. Aunque cada documento sigue teniendo el mismo ángulo todos tienen un a longitud de uno.
