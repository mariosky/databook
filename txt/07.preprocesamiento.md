...
Muchos algoritmos de aprendizaje automático solo pueden recibir como entrada vectores de características con valores continuos. ¿Qué hacemos con aquellos objetos que tienen atributos con valores categóricos?. Por ejemplo, una persona puede tener el atributo genero ["masculino", "femenino"] o estado civil  ["soltero","en una relación","casado", "en relación abierta", "es complicado", "divorciado"]. Una manera de común de solucionar este problema es simplemente asignarle un número entero a cada opción. Así, los valores de genero  ["masculino", "femenino"] los cambiamos a [ 0, 1] y las opciones de estado civil que acabo de decir, quedaría como [0, 1, 2, 3, 4, 5]. El problema que tiene esta solución es que se asume un orden, pero estos atributos no son ordinales; lo cual puede ser un problema en algunos casos.
