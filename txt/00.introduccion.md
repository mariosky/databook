...
Esta sección tiene como objetivo que tengas una visión general acerca 
del tema central de este libro: La extracción de conocimiento a partir de
grandes cantidades de datos. Incluso el tema puede intimidarnos al principio. Como tal vez te imagines no es una tarea sencilla ya que involucra distintas áreas de investigación científica y un buen número de tecnologías. Como buena notica te digo que desde el principio te darás cuenta que estas técnicas tienen muchas aplicaciones. Vamos a empezar con estos temas:  
...
## Introducción
![SistemasExpertos](../img/doctor.jpg)
