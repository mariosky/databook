Esta sección tiene como objetivo que tengas una visión general acerca de las áreas de investigación, tecnologías y aplicaciones que involucran la extracción de conocimiento a partir de grandes cantidades de datos. Para esto veremos:
