...
![¿Cómo diseñarías un robot médico?](../img/doctor.jpg){ width=70% }
...
requerimientos de un usuario te dirá que fue una tarea cercana a lo imposible.
...
áreas de investigación. ## Descubrimiento de conocimiento en bases de datos
...
![El proceso del KDD según Brachman y Anand [-brachman1996process].][image-2]
...
![Minería de Datos][image-3]{ width=70% }
...
![Internet de las Cosas, Ciudades Inteligentes ][image-4] { width=70% }\
...
![Reconocimiento de patrones en multimedia][image-5]{ width=70% }
...
![El tamaño del espacio aumenta exponencialmente haciendo que los datos disponibles se vuelvan dispersos][image-6]{ width=70% }
